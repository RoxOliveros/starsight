...
class PuzzleDatabaseService {
  ...
  static Future<void> saveGameData({
    ...
    try {
      ...
      // 1. Current cycle (playthrough number)
      ...
      // 2. Has the child finished a full playthrough AND replayed a game?
      ...
      // 3. Save into the (possibly new) cycle
      await cycleRef.set({
      ...
      debugPrint('Puzzle Cycle Tracking Error: $e');
    }
  }
