...
class Emotion5Screen extends StatefulWidget {
  ...
  @override
  State<Emotion5Screen> createState() => _Emotion5ScreenState();
}

class _Emotion5ScreenState extends State<Emotion5Screen>
  ...
  Future<void> _playIntroAudio() async {
      ...
      if (mounted) {
        if (_isSuccessAudioPlaying) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => const Emotion6Screen(), // Next Screen!
            ),
          );
        } else {
    ...
    await _narratorPlayer.play(
      AssetSource('audio/lumi_town/level6/emotion_p3.wav'),
    );
  }
                    ...
                    child: DragTarget<DrWooState>(
                      onAcceptWithDetails: (details) async {
                        ...
                        if (droppedState == DrWooState.correct &&
                          ...
                          await _narratorPlayer.play(
                            AssetSource(
                              'audio/lumi_town/level6/emotion_p3_rc.wav',
                            ),
                          );
                      ...
                      builder: (context, candidateData, rejectedData) {
                        return Stack(
                          ...
                          children: [
                            ...
                            Image.asset(
                              _isCorrectlyAnswered
                                  ? 'assets/images/objects/lumi/e3_right.png'
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildReactionDraggable(
                          'assets/images/objects/lumi/scared_wb.png',
                          DrWooState.correct,
                          starButtonSize,
                        ),
