...
class Emotion6Screen extends StatefulWidget {
  const Emotion6Screen({super.key});

  @override
  State<Emotion6Screen> createState() => _Emotion6ScreenState();
}
      ...
      if (mounted) {
        if (_isSuccessAudioPlaying) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) => const Emotion7Screen(), // Next Screen!
            ),
          );
        } else {
                      ...
                      builder: (context, candidateData, rejectedData) {
                        return Stack(
                          ...
                          children: [
                            ...
                            Image.asset(
                              _isCorrectlyAnswered
                                  ? 'assets/images/objects/lumi/e4_right.png'
