...
import 'game_which_comes_first.dart';
          ...
          Padding(
            ...
            child: Stack(
              ...
              children: [
                ...
                Align(alignment: Alignment.center, child: PuzzleGameHeader(title: 'Rotate the Shape')),
      ...
      return GoodJobOverlay(
        ...
        onNext: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => WhichComesFirstScreen(level: widget.level + 1),
            ),
          );
        },
        onRestart: () {
