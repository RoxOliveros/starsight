...
class Lvl10JarMemoryMatch2Screen extends StatefulWidget {
  const Lvl10JarMemoryMatch2Screen({super.key});

  @override
  State<Lvl10JarMemoryMatch2Screen> createState() =>
      _Lvl10JarMemoryMatch2ScreenState();
}

class _Lvl10JarMemoryMatch2ScreenState extends State<Lvl10JarMemoryMatch2Screen>
    ...
    if (cardA.pairId == cardB.pairId) {
      ...
      if (_matchesFound == _kPairsPerRound) {
        ...
        if (_round >= _kTotalRounds) {
          ...
          await sub.cancel();
          await PuzzleProgressService.instance.markLevelComplete(10);
  ...
  Widget _buildWinOverlay() {
    return GoodJobOverlay(
      ...
      onRestart: () {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (_) => const Lvl10JarMemoryMatch2Screen()),
        );
      },
      onBack: () {
        Navigator.of(context).pushReplacement(
