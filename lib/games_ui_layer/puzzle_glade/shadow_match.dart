        ...
        Padding(
          ...
          child: Stack(
            ...
            children: [
              ...
              Align(alignment: Alignment.center, child: PuzzleGameHeader(title: 'Shadow Match')),
        ...
        children: [
          Padding(
            ...
            Stack(
              ...
              children: [
                Align(alignment: Alignment.centerLeft, child: PuzzleBackButton()),
                Align(alignment: Alignment.center, child: PuzzleGameInstruction(instruction: 'Drag the matching picture onto its shadow')),
                Align(alignment: Alignment.centerRight, child: PuzzleLevelBadge(level: widget.level)),
              ],
            ),
          ),
    ...
    return GoodJobOverlay(
      ...
      onNext: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => JigsawPuzzleScreen(level: widget.level + 1),
          ),
        );
      },
      onRestart: () {
