...
const int _kGridSize = 2; // 2 objects per round
...
class _Lvl16CopyPatternScreenState extends State<Lvl16CopyPatternScreen>
  ...
  void _startRound() {
    ...
    final distractors = shuffled.skip(_kGridSize).take(1).toList();
    ...
    return GoodJobOverlay(
      ...
      onNext: () {
        Navigator.of(context).pushReplacement(
          MaterialPageRoute(builder: (_) => const Lvl17SpotDifferenceScreen()),
        );
      },
      onRestart: () {
        Navigator.of(context).pushReplacement(
