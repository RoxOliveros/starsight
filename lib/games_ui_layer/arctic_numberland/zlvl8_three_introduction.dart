...
// import 'zlvl9_four_introduction.dart';
...
//     if (!mounted) return;
//     await _playAudio('assets/audio/arctic_numberland/level9/three_know.wav');
//     if (!mounted) return;
//     await Future.delayed(const Duration(milliseconds: 300));
//     if (!mounted) return;
//
...
//     await Future.delayed(const Duration(milliseconds: 300));
//     if (!mounted) return;
//     await _playAudio('assets/audio/arctic_numberland/level9/three_write.wav');
//     if (!mounted) return;
//   }
//
...
//                     _playAudio(
//                       'assets/audio/arctic_numberland/level9/three_count_tree.wav',
//                     );
//                   },
//                 )
//               else ...[
