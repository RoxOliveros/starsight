...
// import 'zlvl3_two_introduction.dart';
...
//     if (!mounted) return;
//     await _playAudio('assets/audio/arctic_numberland/level2/one_know.wav');
//     if (!mounted) return;
//     await Future.delayed(const Duration(milliseconds: 300));
//     if (!mounted) return;
//
...
//     await Future.delayed(const Duration(milliseconds: 300));
//     if (!mounted) return;
//     await _playAudio('assets/audio/arctic_numberland/level2/one_write.wav');
//     if (!mounted) return;
//   }
//
...
//           SafeArea(
//             child: Padding(
//               padding: const EdgeInsets.only(top: 20),   // <-- add this
//               child: Stack(
//                 children: [
...
//                     _playAudio(
//                       'assets/audio/arctic_numberland/level2/one_click_snowman.wav',
//                     );
//                   },
//                 )
//               else ...[
