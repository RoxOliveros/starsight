...
class _SnowmanShapeHuntGameState extends State<SnowmanShapeHuntGame>
  ...
  static final List<_RoundSpec> _rounds = [
    const _RoundSpec([
      _SnowmanSpec([
        _ShapeSpot(
          id: 'nose',
          correctShape: _ShapeType.triangle,
          anchorX: 0.5,
          anchorY: 0.25,
          trayChoices: 2,
        ),
    ...
    const _RoundSpec([
      _SnowmanSpec([
        ...
        _ShapeSpot(
          id: 'button1',
          correctShape: _ShapeType.circle,
          anchorX: 0.485,
          anchorY: 0.44,
          trayChoices: 2,
        ),
    ...
    const _RoundSpec([
      _SnowmanSpec([
        ...
        _ShapeSpot(
          id: 'button2',
          correctShape: _ShapeType.square,
          anchorX: 0.48155,
          anchorY: 0.52,
        ),
      ]),
  ...
  List<_ShapeType> _buildTrayForRound(_SnowmanSpec snowman) {
    ...
    final distractors =
        _ShapeType.values.where((s) => !needed.contains(s)).toList()
          ..shuffle(Random());
  ...
  Future<void> _startIntroFlow() async {
    ...
    if (mounted)
      playVoiceRestartingOnFaceLoss(
        audio.voicePlayer,
        _audioInstruction,
      ); // only fires here, once, for round 1
  }
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: highlight
                      ...
                      : ArcticColorTheme.slateblue.withValues(alpha: 0.6),
                  width: 2.5,
                ),
              ),
        ...
        children: [
          Transform.translate(
            ...
            child: _shapeGlyph(
              shape,
              size * 0.8,
              color: wrong ? Colors.red.shade100 : ArcticColorTheme.slateblue,
            ),
          ),
        ],
      ),
    ...
    return DomaGoodJobOverlay(
      ...
      onRestart: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => SnowmanShapeHuntGame(level: widget.level),
          ),
        );
      },
