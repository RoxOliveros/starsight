...
// ─────────────────────────────────────────────────────────────────────────────
// TapCountScreen — "Tap the right number of objects!"
//
// A number is shown on the left. 5 objects are shown on the right.
// The child taps exactly that many objects, then hits Submit.
// Over-tapping is allowed but submission flashes red.
// Correct → short celebration → auto-advance.
// 5 rounds, numbers 1–5, one per round (shuffled).
// Each round uses a different object type (themed per number).
// ─────────────────────────────────────────────────────────────────────────────
...
class _TapCountScreenState extends State<TapCountScreen>
  ...
  static const int _poolSize = 5; // always show 5 objects
